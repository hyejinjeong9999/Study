...
* 선택창1에 선택한 내용이 선택창 2에는 안보이게..

![image-20200115140903731](C:\Users\student\Desktop\혜\til\img\image-20200115140903731.png)
			...
			$(document).ready(function() {
				...
				skillManage.change(function(){
					...
					if(obj.index() != 0 && obj.prev().val() == '') {
                        //prev(이전) 값이 비었으면 :  이전 스킬을 먼저 선택하세요 후 값을 비우게 됨
               //			<-> next() 다음을 의미
