...
import dbConn.utill.ConnectionHelper;
...
public class JDBCProjectEx2 extends JFrame 
	...
	private String sqlDelete="DELETE FROM CUSTOMERS CUSTOMERS WHERE NAME = ?";
	...
	public void dbConnect() {
		try {
			...
			pstmtInsert = conn.prepareStatement(sqlDelete);
			pstmtInsert = conn.prepareStatement(sqlTotal);
			pstmtInsert = conn.prepareStatement(sqlSearch);
